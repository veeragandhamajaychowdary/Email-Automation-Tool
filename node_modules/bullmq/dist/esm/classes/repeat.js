...
export class Repeat extends QueueBase {
    ...
    async addNextRepeatableJob(name, data, opts, skipCheckExists) {
        ...
        if (nextMillis) {
            ...
            const repeatJobKey = await this.scripts.addRepeatableJob((_b = opts.repeat.key) !== null && _b !== void 0 ? _b : this.hash(repeatConcatOptions), nextMillis, {
                name,
            ...
            }, repeatConcatOptions, skipCheckExists);
